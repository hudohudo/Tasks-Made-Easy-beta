...
public class GUI_project extends JPanel
{
    ...
    public GUI_project()
    {
        ...
        removeTask.addActionListener(new RemoveTaskAction());
        removeTask.setBounds(25,430,100,35);
        removeTask.setBackground(new Color(50,109,255));
        removeTask.setForeground(new Color(0,0,0));
        removeTask.setEnabled(true);
        removeTask.setFont(new Font("Arial",0,12));
        removeTask.setText("Remove Task");
        removeTask.setVisible(true);
        add(removeTask);

        removeTaskText = new JTextField(2);
        removeTaskText.setBounds(133,435,40,28);
    ...
    private class CreateAction implements ActionListener{
        public void actionPerformed(ActionEvent e){
            ...
            else
            {
                ...
                if((month<12) || ((month==1 || month==3 || month==5 || month==6 || month==7 || month==8 || month==10 || month==12) && day<31)
                ...
                {
                    dialogueBox.setText("Invalid date");
                }
            }
        }
    }
    private class RemoveTaskAction implements ActionListener{
        public void actionPerformed(ActionEvent e){
            int ind = Integer.parseInt(removeTaskText.getText());
            try {
                TasksMadeEasy.removeTask(ind-1);
                dialogueBox.setText("Task removed");
            } catch (IndexOutOfBoundsException error) {
                errorMessage = error.getMessage();
                dialogueBox.setText("Invalid index");
            }
            removeTaskText.setText("");
        }
    }
